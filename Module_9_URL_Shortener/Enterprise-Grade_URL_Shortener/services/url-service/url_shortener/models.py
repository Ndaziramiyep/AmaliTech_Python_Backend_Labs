...
class Url(models.Model):
    ...
    # Set by the nightly archive_expired_urls Celery Beat task once expires_at
    # has passed — kept separate from is_active so "archived" (past expiry,
    # swept by cleanup) stays distinguishable from "deactivated" (owner choice).
