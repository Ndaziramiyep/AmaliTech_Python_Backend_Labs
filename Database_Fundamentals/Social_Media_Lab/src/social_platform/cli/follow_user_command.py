"""Composition root for the follow-user CLI command."""
...
def main(argv: Sequence[str] | None = None) -> int:
    """Parse arguments and follow one user on behalf of another."""
    parser = argparse.ArgumentParser(description="Follow a user.")
    ...
    try:
        result = following_service.follow_user(
