...
def _handle_login(
    input_function: InputFunction, repository_bundle: RepositoryBundle
) -> User | None:
...
def _handle_add_comment(
    ...
    post_id = _select_post_id(input_function, repository_bundle, user, "comment on")
    if post_id is None:
        return
...
def _handle_like_post(
    ...
    post_id = _select_post_id(input_function, repository_bundle, user, "like")
    if post_id is None:
        return
...
def _select_post_id(
    input_function: InputFunction, repository_bundle: RepositoryBundle, user: User, action_verb: str
) -> int | None:
